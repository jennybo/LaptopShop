...
public class ProductGet {
   public static Connection connection = DBConnect.getConnecttion();
...
public boolean delete(long product_id) throws SQLException {
 ...
 public boolean insertProduct(Product c) {
    ...
    public ArrayList<Product> getListProductByPages(int firstResult, int maxResult) throws SQLException {
   ...
   //     System.out.println(p.getProductID() + " - "+p.getProductName());} 
        ...
        System.out.println(get.getListProductByPages(13, 14));
    }
}
